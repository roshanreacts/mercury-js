...
export { RedisStore };
export declare const createRateLimitRuleContext: (
  config: import('graphql-rate-limit').GraphQLRateLimitConfig
) => (
  fieldConfig: import('graphql-rate-limit').GraphQLRateLimitDirectiveArgs
) => import('graphql-shield').IRule;
